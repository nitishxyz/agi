		...
		>
			<div className="h-14 flex items-center">
				...
				<div className="hidden md:flex items-center gap-5 text-[13px] ml-auto">
					<Link to="/docs" className="text-otto-muted hover:text-otto-text transition-colors">
						Docs
					</Link>
					<a
				...
				<a
					href="#desktop"
					className="px-3.5 py-1.5 border border-otto-border text-otto-muted text-xs rounded-sm hover:border-otto-border-light hover:text-otto-text transition-colors flex items-center gap-1.5"
					>
					...
					<a
						href="#install"
						className="px-3.5 py-1.5 bg-otto-text text-otto-bg text-xs font-medium rounded-sm hover:opacity-80 transition-colors"
					>
						Install
					</a>
				</div>
