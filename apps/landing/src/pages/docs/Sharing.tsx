...
export function Sharing() {
	return (
		<div>
			...
			<p className="text-otto-dim text-sm mb-8">Share coding sessions as public read-only links.</p>
...
otto share --title "Auth refactor" --description "Rewrote JWT flow"`}</CodeBlock>
			...
			<p>
				<a href="https://share.ottocode.io/s/cjqwnr6mPsPIUAjG79daV" target="_blank" rel="noopener noreferrer" className="text-otto-text underline underline-offset-4 hover:text-otto-muted transition-colors">
