  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ fontSize: 18, color: colors.dim, letterSpacing: "0.3em", textTransform: "uppercase" as const, marginBottom: 20, fontFamily: font.mono, fontWeight: 500 }}>
            How it works
          </div>
          <div style={{ fontSize: 72, fontWeight: 700, color: colors.text, letterSpacing: "-0.03em", lineHeight: 1.05 }}>
            Runs where
            <br />
            you do.
          </div>
            ...
            return (
              ...
              >
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
                  ...
                  <span style={{ fontSize: 17, color: colors.muted, lineHeight: 1.5 }}>
                    {item.desc}
                  </span>
                </div>
              </div>
