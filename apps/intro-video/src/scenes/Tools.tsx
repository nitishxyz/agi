  ...
  return (
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        >
          <div style={{ fontSize: 18, color: colors.dim, letterSpacing: "0.2em", textTransform: "uppercase" as const, marginBottom: 14 }}>
            Built-in Tools
          </div>
          ...
          {TOOLS.map((tool, i) => {
            ...
            return (
              ...
              >
                ...
                <span style={{ fontSize: 16, color: tool.color, fontWeight: 500 }}>
                  {tool.category}
                </span>
              </div>
            );
