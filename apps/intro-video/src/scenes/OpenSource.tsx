      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 36, transform: `translateY(${floatY}px)` }}>
        <div style={{ position: "relative" }}>
          ...
          <div style={{ transform: `scale(${computedGhScale})`, opacity: ghProgress, position: "relative" }}>
            <svg width={140} height={140} viewBox="0 0 24 24" fill={colors.text}>
        ...
        <div style={{ display: "flex", gap: 28, marginTop: 12 }}>
          {STATS.map((stat, i) => {
            ...
            return (
              ...
              >
                <span style={{ fontSize: 46, fontWeight: 700, color: colors.text }}>
                  {stat.value}
                </span>
                <span style={{ fontSize: 22, color: colors.dim }}>
                  {stat.label}
                </span>
              </div>
            );
