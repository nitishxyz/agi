  ...
  return (
    ...
    >
      <div style={{ width: 1350 }}>
        ...
        >
          <div style={{ fontSize: 20, color: colors.dim, letterSpacing: "0.25em", textTransform: "uppercase" as const, marginBottom: 14, fontFamily: font.mono, fontWeight: 500 }}>
            Interfaces
          </div>
          <div style={{ fontSize: 64, fontWeight: 700, color: colors.text, lineHeight: 1.2, letterSpacing: "-0.03em" }}>
          ...
          {INTERFACES.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                <div style={{ fontSize: 16, color: colors.dim, textTransform: "uppercase" as const, letterSpacing: "0.15em", marginBottom: 8 }}>
                  {item.tag}
                </div>
                <div style={{ fontSize: 30, fontWeight: 600, color: colors.text, marginBottom: 16 }}>
                  {item.headline}
                </div>
                <code style={{ fontSize: 17, color: colors.dim, background: colors.surface, padding: "8px 16px", borderRadius: 8, border: `1px solid ${colors.border}` }}>
                  {item.cmd}
                </code>
              </div>
            );
