...
import HoldingCard, { type HoldingData } from './holding-card';
import { Box } from './primitives/box';
import { Icon } from './primitives/icon';
import type { SwipeableCard } from './optimized-swipeable-cards';
	...
	return (
		<Box m="md" mb="sm" style={{ position: 'relative' }}>
			<Animated.View style={containerStyle}>
				<HoldingCard holding={currentHolding} width={leftCardWidth} />
				<HoldingCard holding={newHolding} width={rightCardWidth} />
			</Animated.View>
