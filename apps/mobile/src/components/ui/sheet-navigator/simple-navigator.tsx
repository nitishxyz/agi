...
const SheetNavigatorContext = createContext<SheetNavigatorContextType | null>(
	null,
);
		...
		if (currentIndex !== prevIndex) {
			...
			currentContentTranslateX.value = withTiming(
				...
				() => {
					...
					currentContentTranslateX.value = isNext
						? slideDistance
						: -slideDistance;
					...
					<Animated.View style={[animatedStyle, styles.sheetContainer]}>
						...
						>
							...
							<Box style={styles.contentContainer}>
								<Animated.View
									style={[styles.stepContent, contentAnimatedStyle]}
								>
									{StepComponent && (
										<StepComponent
