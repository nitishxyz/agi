...
const SETU_SOURCE = 'https://api.setu.ottocode.io/v1/models';
...
function pickProviders(
	...
	const out: Partial<Record<ProviderId, ProviderCatalogEntry>> = {
...
function toTs(catalog: Partial<Record<ProviderId, ProviderCatalogEntry>>) {
...
async function updateSetuCatalog() {
	...
	const header = `// AUTO-GENERATED by scripts/update-catalog.ts --setu. Do not edit manually.\n`;
	const types = `import type { SetuModelCatalogEntry, SetuCatalog } from './catalog.ts';\n`;
	const reexport = `export type { SetuModelCatalogEntry, SetuCatalog } from './catalog.ts';\n`;
