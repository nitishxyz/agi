...
async function main() {
  ...
  try {
    ...
    if (!devMode) {
      ...
      console.log('\n✅ Build complete!');
      console.log('\n📦 Output locations:');
      console.log('   macOS DMG:    apps/desktop/src-tauri/target/release/bundle/dmg/');
      console.log('   macOS App:    apps/desktop/src-tauri/target/release/bundle/macos/');
      console.log('   Windows MSI:  apps/desktop/src-tauri/target/release/bundle/msi/');
      console.log('   Linux:        apps/desktop/src-tauri/target/release/bundle/appimage/');
    } else {
